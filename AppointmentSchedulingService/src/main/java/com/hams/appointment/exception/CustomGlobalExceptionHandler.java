...
public class CustomGlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(AppointmentNotFoundException exception,
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(DoctorNotAvailableException exception,
			WebRequest webRequest) {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(InvalidDoctorException exception,
			WebRequest webRequest) {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(InvalidPatientException exception,
			WebRequest webRequest) {
