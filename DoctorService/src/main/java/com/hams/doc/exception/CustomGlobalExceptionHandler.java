...
public class CustomGlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(DoctorNotFoundException exception,
	...
	@ExceptionHandler(value = InvalidDayException.class)
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(InvalidDayException exception,
			WebRequest webRequest) {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(ScheduleNotFoundException exception,
			WebRequest webRequest) {
